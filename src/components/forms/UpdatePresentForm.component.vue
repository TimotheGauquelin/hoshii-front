...
<template>
    <form class="space-y-4 md:space-y-6" method="put" @submit.prevent="emit('updateList', userId, list._id)">
        ...
        <Input 
            ...
            inputName="label"
            placeholder="label"
            v-model:newValue=list.presents[clickedPresentIndex].label
            />
        <Input 
            type="text"
            ...
            inputName="desc"
            placeholder="desc"
            v-model:newValue=list.presents[clickedPresentIndex].desc
            />
        <Input 
            type="number"
            ...
            inputName="price"
            placeholder="price"
            v-model:newValue=list.presents[clickedPresentIndex].price
            />
        <button 
            type="submit"
